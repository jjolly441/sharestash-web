...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message?.includes('already') ? 'An account with this email already exists' : 'Registration failed. Please try again.');
    }
    setLoading(false);
  };
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-brand-dark mb-1">Create your account</h1>
          <p className="text-gray-500">Join the ShareStash community</p>
        </div>
